...
impl FmcdEvent {
    ...
    pub fn timestamp(&self) -> DateTime<Utc> {
        match self {
            ...
            FmcdEvent::WithdrawalCompleted { timestamp, .. } => *timestamp,
    ...
    pub fn correlation_id(&self) -> Option<&String> {
        match self {
            ...
            FmcdEvent::WithdrawalCompleted { correlation_id, .. } => correlation_id.as_ref(),
    ...
    pub fn event_type(&self) -> &'static str {
        match self {
            ...
            FmcdEvent::WithdrawalCompleted { .. } => "withdrawal_completed",
